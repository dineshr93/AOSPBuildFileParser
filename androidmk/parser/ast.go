...
type Node interface {
	...
	Pos() Pos
	End() Pos
	DumpALL() (string, string, string, string)
}
...
func (x *Assignment) DumpALL() (string, string, string, string) {
	target := ""
	if x.Target != nil {
		target = x.Target.Dump() + ": "
	}
	// _ = target
	return target + "__", x.Name.Dump() + "__", x.Value.Dump() + "__", x.Type + "__"
}
...
func (x *Assignment) Dump() string {
	...
	return "Assignment:  " + target + x.Name.Dump() + " " + x.Type + " " + x.Value.Dump()
}
...
func (x *Comment) DumpALL() (string, string, string, string) {
	return "", "", "", ""
}
...
func (x *Directive) DumpALL() (string, string, string, string) {
	return "", "", "", ""
}
func (x *Directive) Dump() string {
	return "Directive:  " + x.Name + " " + x.Args.Dump()
}
...
func (x *Rule) DumpALL() (string, string, string, string) {
	return "", "", "", ""
}
...
func (x *Variable) DumpALL() (string, string, string, string) {
	return "", "", "", ""
}
